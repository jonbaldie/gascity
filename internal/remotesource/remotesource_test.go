...
func TestParseSourceForms(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			source:   "https://github.com/jonbaldie/gascity.git//internal/bootstrap/packs/core#main",
			cloneURL: "https://github.com/jonbaldie/gascity.git",
			subpath:  "internal/bootstrap/packs/core",
			ref:      "main",
		},
		{
			name:     "short github",
			source:   "github.com/jonbaldie/gascity//examples/bd",
			cloneURL: "https://github.com/jonbaldie/gascity",
			subpath:  "examples/bd",
		},
		{
			name:     "no git suffix",
			source:   "https://github.com/jonbaldie/gascity//examples/bd/dolt",
			cloneURL: "https://github.com/jonbaldie/gascity",
			subpath:  "examples/bd/dolt",
		},
		{
			name:      "github tree",
			source:    "https://github.com/jonbaldie/gascity/tree/release/examples/gastown/packs/maintenance",
			cloneURL:  "https://github.com/jonbaldie/gascity.git",
		...
		},
		{
			...
			source:    "https://github.com/jonbaldie/gascity/blob/release/examples/gastown/packs/gastown/pack.toml",
			cloneURL:  "https://github.com/jonbaldie/gascity.git",
